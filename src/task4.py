...
def collect_data_once(min_conf=0.6, cam_index=0):
    ...
    with mp_hands.Hands(static_image_mode=False, max_num_hands=1,
        ...
        while True:
            ...
            cv2.putText(frame,"Press 0..4 | 'q' or ESC to quit",(10,60),cv2.FONT_HERSHEY_SIMPLEX,0.6,(255,255,255),1)
...
def realtime(clf,min_conf=0.6,cam_index=0):
    ...
    with mp_hands.Hands(static_image_mode=False,max_num_hands=1,
        ...
        while True:
            ...
            cv2.putText(frame,f"Gesture: {label_to_show}",(10,30),cv2.FONT_HERSHEY_SIMPLEX,0.9,color,2)
            cv2.putText(frame,"Press 'q' or ESC to quit",(10,60),cv2.FONT_HERSHEY_SIMPLEX,0.6,(255,255,255),1)
